...
SECRET_KEY = os.getenv('SECRET_KEY', 'p$d*2!rp6)lnc6^7_4^qsy8+ig8i&ep0mp+eqgchswqk6a^y_7')
...
# We're only using the database for temporarily storing some session variables
# --> TODO: Consider switch to more lightweight framework - maybe Flask?
DATABASES = {
    'default': {
